...
class Dashboardsummary extends StatelessWidget {
  ...
  // Aspect ratio adapts so cards don't get too tall as column count rises.
            ...
            child: SingleChildScrollView(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final ratio = _gridAspectRatio(constraints.maxWidth);
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      GridView.count(
                        crossAxisCount: cols,
                        crossAxisSpacing: ref * 0.035,
                        mainAxisSpacing: ref * 0.035,
